...
OUT = ROOT / "evidence/multimodal-v2"
MEDIA = WORK / "multimodal-media-v2"
PROMPTS = {
...
def main():
    ...
    save(OUT / "results.json", rows)
    sources = ["experiments/run_multimodal_v2.py", "context_stamps/guarded_activation.py", "context_stamps/activation.py",
