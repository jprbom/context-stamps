...
The [Terminal-Bench 2.1 development pilot](../evidence/terminal-pilot-v1/ATTRIBUTION.md)
has separate Apache-2.0 task attribution. Its records include public instructions,
generated commands and native grader reports; raw task trees, reference solutions
