...
Do not commit source corpora, private traces, model weights, credentials, database files or generated caches. Add small redistributable fixtures instead. Keep optional adapters explicit about first-use downloads and model licenses.
